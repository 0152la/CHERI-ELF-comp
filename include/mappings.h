...
mappings_list* mappings_init();
void mappings_clean(mappings_list*);
void mappings_clean_deep(mappings_list*);
void mappings_insert(mapping_entry*, mappings_list*);
struct CompMapping* mappings_search_free(struct Compartment*, mappings_list*);
void mappings_delete(struct CompMapping*, mappings_list*);
